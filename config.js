...
const CONFIG = {
  ...
  // ─── BUSINESS INFO ───────────────────────────────────────
  business: {
    name:      "Maid n Clean (Pty) Ltd",
    phone:     "+27 67 708 5875",
    whatsapp:  "+27 67 708 5875",
    address:   "8 Judges Ave, Randburg, South Africa",
  ...
  // ─── PAGE META / SEO ─────────────────────────────────────
  meta: {
    title:       "Maid n Clean (Pty) Ltd — Pool services in randburg",
    description: "Maid n Clean (Pty) Ltd provides professional pool services in Randburg. 1 Google review. Call for a quote today.",
  ...
  content: {
    ...
    heroLead:   "Maid n Clean (Pty) Ltd keeps swimming pools clean, chemically balanced and fully functional across Randburg. Maintenance, repairs, pump and filter work — we handle it all.",
    ...
    band: {
      ...
      alt:   "Maid n Clean (Pty) Ltd team at work in Randburg",
